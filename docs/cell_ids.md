...
For the sugar stimulus, XLSX `Root_Side = "L"` corresponds to Shiu's "right" stimulus side, which is where all 23 frozen sugar cells sit ([cell-set cross-check](cell_set_crosscheck.md#sugar-23-ids-modality-subtypes-lb3b--lb3c)).
