...
The primary IDs from `example.ipynb` are left `720575940660219265` and right `720575940618238523`; both are present in v783. `figures.ipynb` uses the same left ID but lists right `720575940645521262`, which is absent from v783. The frozen readout is therefore `left_only`, matching the paper's contralateral left-MN9 readout. Right MN9 is still recorded and reported, but it is not used for gates.
