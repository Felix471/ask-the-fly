...
- water: free water at low solute concentration, as sensed by osmolarity, not liquid volume. very_high = plain water, clear tea, clear broth; high = dilute liquids with little sugar or salt (milk, most soups); medium = sweetened or salty drinks and sauces (cola, juice, bubble tea, miso soup); low = moist solids and syrups (honey, cake, fruit); none = dry solids.
