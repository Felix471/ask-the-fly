...
export const STRINGS = {
  "en": {
    ...
    "silenceCaption": "Recorded run with {name}'s synapses set to zero · MN9 {after} vs {before} normal ({delta}) · cf. Tastekin 2026 Fig 6G / S17",
  ...
  "zh": {
    ...
    "silenceCaption": "把 {name} 的突触全部置零后的记录回放 · MN9 {after}，正常时 {before}（{delta}）· 参见 Tastekin 2026 图 6G / S17",
